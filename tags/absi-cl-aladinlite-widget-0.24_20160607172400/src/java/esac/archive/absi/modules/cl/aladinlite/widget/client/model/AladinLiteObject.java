 ...
 * @author ileon
 */
public class AladinLiteObject extends JavaScriptObject {

    protected AladinLiteObject() {
    }
    ...
    /**
     * Retrieve value for ["data"]["idx"] or null if it does not exist.
     * @return String value or null.
     */
    public final native String getIdx() /*-{
		if (this["data"] != undefined) {
			if (this["data"]["idx"] != undefined) {
				return this["data"]["idx"].toString();
			}
		}
		return null;
    }-*/;
    ...
    public final String toFormattedString() {
        ...
        output = output + "DATA -> [Message [" + getMessage() + "], Idx [" + getIdx() + "]]";
        return output;
    }
}
